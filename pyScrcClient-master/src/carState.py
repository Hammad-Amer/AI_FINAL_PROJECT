...
class CarState(object):
    ...
    def getFocusCenter(self):
        if not self.focus: 
            return None
        center = len(self.focus) // 2
        return self.focus[center]
    ...
    # Focus to the left by one beam (15°)
    ...
    # Focus to the right by one beam (15°)
    def getFocusRight(self):
        if not self.focus:
            return None
        center = len(self.focus) // 2
        idx = min(len(self.focus) - 1, center + 1)
        return self.focus[idx]

    def getWheelSpinFL(self):
        return self.wheelSpinVel[0] if self.wheelSpinVel else None

    def getWheelSpinFR(self):
        return self.wheelSpinVel[1] if self.wheelSpinVel else None

    def getWheelSpinRL(self):
        return self.wheelSpinVel[2] if self.wheelSpinVel else None

    def getWheelSpinRR(self):
        return self.wheelSpinVel[3] if self.wheelSpinVel else None
    
    def getTrackDist(self):
        return self.distRaced  